 ...
 *
 * These constants are used both to construct the registered memslots
 * (g_memslots[]) and by the dirty-tracking / migration code, so the
 * design-time topology is defined in one place. The registered runtime
 * view remains g_memslots[] (see Step 41 / Ctrl-A e).
 */
#define MEM_SLOT0_ID    0
#define MEM_SLOT1_ID    1

#define MEM_SLOT0_GPA   0x00000000ULL
#define MEM_GAP_START   0x000D0000ULL   /* unregistered GPA gap (early MMIO experiment) */
