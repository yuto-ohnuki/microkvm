...
gdt:
    .quad 0                     /* GDT[0]: null */
    .quad 0x00CF9A000000FFFF    /* GDT[1]: 32-bit code, exec/read */
    .quad 0x00CF92000000FFFF    /* GDT[2]: 32-bit data, read/write */
...
The VMM itself (`microkvm.c`) is unchanged from Step 2 except for replacing the inline byte array with this file loader. The exit handler loop remains the same.
